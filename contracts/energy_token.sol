...
contract EnergyToken is ERC721Token {
    ...
    function mint(address _to, bytes32 _secretHash) public {
    // function mint(address _to, string _uniqueDescription) public {
        ...
        string memory uriHashStr = bytes32ToString(_secretHash);
    ...
    function tokenIdByURI(bytes32 _uri) public view returns(uint256) {
